...
targetdir <- here("temp_data", "GAEZ", "v4", "AEAY_out_density", "Rain-fed-all-phases", "High-input")
...
writeRaster(gaez_all, here("temp_data", "GAEZ", "v4", "AEAY_out_density", "Rain-fed-all-phases", "high_input_all.tif"), 
            overwrite = TRUE)
