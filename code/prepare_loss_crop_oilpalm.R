...
transition_types <- c("cropland", "oilpalmboth", "oilpalmindus")
...
tropical_stack <- stack(losscropland, lossoilpalmboth, lossoilpalmindus,
                        gaez, 
                        fc2k, 
                        pst2k)
# stock those names 
...
long_df <- stats::reshape(wide_df,
                          ...
                          v.names = c("loss_cropland", "loss_oilpalm_both", "loss_oilpalm_indus"),
                          sep = ".",
                          timevar = "year",
